...
class SpringLoomDemoApplicationTest {
    ...
    void mainRunSuccessful() {
        try (MockedStatic<SpringApplication> mockedStatic = mockStatic(SpringApplication.class)) {
            ...
            SpringLoomDemoApplication.main(new String[]{});

            mockedStatic.verify(() -> SpringApplication.run(SpringLoomDemoApplication.class, new String[]{}));
        }
    }
}
